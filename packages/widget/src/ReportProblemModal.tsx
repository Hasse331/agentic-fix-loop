...
export function ReportProblemModal() {
  const { projectName, isOpen, close } = useAgenticFixLoop();
          ...
          <div style={{ marginTop: 16 }}>
            ...
            <label style={labelStyle}>
              ...
              <input
                ...
                value={draft.pageUrl}
                onChange={(event) =>
                  setDraft(updateDraft(draft, "pageUrl", event.target.value))
                }
              />
            </label>
            {errors.pageUrl ? (
            ...
            <label style={labelStyle}>
              ...
              <textarea
                ...
                onChange={(event) =>
                  setDraft(
                    updateDraft(draft, "whatWereYouDoing", event.target.value)
                  )
                }
              />
            </label>
            ...
            {submitError ? (
              <p style={{ color: "#b91c1c", marginTop: 12 }}>{submitError}</p>
            ) : null}
